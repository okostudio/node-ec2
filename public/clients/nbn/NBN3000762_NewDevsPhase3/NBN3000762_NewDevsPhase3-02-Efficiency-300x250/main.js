...
function StartBanner() {
    ...
    // animate lines
    var LINES = new gsap.timeline({repeat: 1, repeatDelay: 0})
    ...
    addLines(".lines #green path", 0, 4.0)



    var FRAME1 = new gsap.timeline()
        .from(".frame1 .line", {duration: 0.5, y: 15, opacity: 0, display: "none", ease: Power3.easeOut, stagger: 0.08 }, "+=0.25")

    var FRAME2 = new gsap.timeline()
        .to(".frame1 .line", {duration: 0.6, opacity: 0, display: "none", ease: Power3.easeIn })     
        .from(".frame2 .line", {duration: 0.5, y: 15, opacity: 0, display: "none", ease: Power3.easeOut, stagger: 0.08 })
    ...
    var ENDFRAME = new gsap.timeline({onComplete: function(){console.log("time" + banner.width + "x" + banner.height, new Date() - banner.time)}})
        ...
        .from(".tagline .letter", {opacity: 0, stagger: 0.05, duration: 0.4, ease: Sine.easeIn}, "-=1")
