...
function StartBanner() {
    ...
    var FRAME4 = new gsap.timeline()
        .to(".frame3 .copy", {duration: 0.66, opacity: 0, display: "none", ease: Power2.easeIn })     
        .from(".logo", {duration: 0.8, x: 180, ease: Power2.easeInOut}, "-=0.3")

    var FRAME5 = new gsap.timeline()
        .to(".logo", {duration: 0.66, opacity: 0, display: "none", ease: Power2.easeIn })     
        .from(".owaf", {duration: 0.66, opacity: 0, display: "none", ease: Power2.easeOut })

    var FRAME6 = new gsap.timeline()
        .to(".owaf", {duration: 0.66, opacity: 0, display: "none", ease: Power2.easeIn })
        // .fromTo(".terms.panel", {display: "none", opacity: 0}, {duration: 0.66, display: "block", opacity: 1, ease: Power2.easeIn})
        // .to(".terms.panel", {duration: 0.66, display: "none", opacity: 0, ease: Power2.easeIn }, "+=4")
        .from(".cta", {duration: 0.66, opacity: 0, display: "none", ease: Power2.easeIn })
